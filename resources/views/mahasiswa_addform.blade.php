...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <form action="{{ route('data.mahasiswa.addform.process') }}" method="POST" class="mb-5" enctype="multipart/form-data">
          @csrf()
        <div class="row g-3 align-items-center form-group">
          ...
          <div class="col-auto">
            <span id="passwordHelpInline" class="form-text">
              NIM harus angka dan terdiri dari 10 karakter.
            </span>
          </div>
        </div>
        <br>
        ...
        <div class="row g-3 align-items-center form-group">
          ...
          <div class="col-md-6">
            <textarea name="alamat" class="form-control" cols="30" rows="7"></textarea>
          </div>
        </div>
        <br>
        <div class="row g-3 align-items-center form-group">
        ...
        <div class="row g-3 align-items-center form-group">
          ...
          <div class="col-md-6">
            <input type="file" name="file_krs" id="file_krs" class="form-control" accept=".pdf" @required(true)>
          </div>
          <div class="col-auto">
            <span id="passwordHelpInline" class="form-text">
        ...
        <div class="row g-3 align-items-center form-group">
          ...
          <div class="col-md-6">
            ...
            <input type="submit" name="addmahasiswa" value="Simpan" class="btn btn-primary">
          </div>
        </div>
      </form>
    </div>
